...
export const data = [
    ...
    // },
    {
        ...
        image: 'images/plan-estrategico-sv.jpeg'
    },
    {
...
export const ServicesProvider = ({ children }) => {
    ...
    const swapPosition = (index1, index2) => {
        [services[index1], services[index2]] = [services[index2], services[index1]];
        //services.push({title:"1",content:"2",image:"3"})
